...
const TransferMoney = () => {
    ...
    const handleTransfer = (e) => {
        e.preventDefault();    
        console.log(bank_name, customer_name, account_no, sender, receiver, ifsc_code, amount,email);
        setIsLoading(true);

        const FullUrl ="http://localhost:3001/money/transfer"
        axios.post(FullUrl,{
            "BankName":bank_name,
    ...
    const PageLoader = ({ isLoading }) => {
        ...
        return (
            <div className={`page-loader ${isLoading ? '' : 'hidden'}`}>
                ...
                <div className="txt">Successfully</div>
            </div>
        );
    };
