...
function Customer() {
  ...
  function handleCustomer(e){
      ...
      const FullUrl ="http://localhost:3001/customer/add"
      axios.post(FullUrl,{
    ...
    <>
      <nav class="nav">
        ...
        <ul class="nav__links">
          ...
          <li class="nav__item">
            <a class="nav__link" href="/customer">Customers</a>
          </li>
          <li class="nav__item">
      ...
      <div class="container">
        ...
        <div className='d-flex justify-content-end'>
                {/* <Link to='/customerAdd'> <button className='bg-danger fs-3 p-1'>Back</button> </Link> */}
                   ...
                   <Link to='/customer'><button className='bg-primary fs-3 p-1'>Customer Data</button></Link> 
                </div>
